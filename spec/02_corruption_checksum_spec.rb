...
RSpec.describe CorruptionChecksum do
  ...
  describe 'evenly divisible' do

    second_input = "5 9 2 8
    9 4 7 3
    3 8 6 5"
    context "divide" do
      it "gets the total number" do
        expect(checksum.compute_division(second_input)).to eq 9
      end

      it "gets the total number for large numbers" do
        large_input = "116    1470    2610    179    2161    2690    831    1824    2361    1050    2201    118    145    2275    2625    2333
        976    220    1129    553    422    950    332    204    1247    1092    1091    159    174    182    984    713
        84    78    773    62    808    83    1125    1110    1184    145    1277    982    338    1182    75    679
        3413    3809    3525    2176    141    1045    2342    2183    157    3960    3084    2643    119    108    3366    2131
        ...
        73    1620    81    1137    812    75    1326    1355    1545    1666    1356    1681    1732    85    128    902
        571    547    160    237    256    30    496    592    385    576    183    692    192    387    647    233"
        expect(checksum.compute_division(large_input)).to eq 236
      end
    end
